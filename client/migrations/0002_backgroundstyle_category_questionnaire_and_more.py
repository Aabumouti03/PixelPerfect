# Generated by Django 5.1.2 on 2025-03-06 03:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='module',
            name='categories',
            field=models.ManyToManyField(related_name='modules', to='client.category'),
        ),
        migrations.AddField(
            model_name='program',
            name='categories',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='client.category')),
                ('questionnaire', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='questions', to='client.questionnaire')),
            ],
        ),
    ]
