...
class RateModuleTestCase(TestCase):
    ...
    def test_authenticated_user_can_rate_module(self):
        ...
        self.assertJSONEqual(response.content, {"success": True, "average_rating": 4.0})
    ...
    def test_average_rating_calculation(self):
        ...
        end_user, _ = EndUser.objects.get_or_create(user=self.user)
        ...
        end_user2, _ = EndUser.objects.get_or_create(user=self.user2)
    ...
    def test_invalid_rating_rejected(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertJSONEqual(response.content, {"success": False, "message": "Invalid rating. Must be between 1 and 5."})
    ...
    def test_invalid_json_data(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertJSONEqual(response.content, {"success": False, "message": "Invalid JSON data"})
