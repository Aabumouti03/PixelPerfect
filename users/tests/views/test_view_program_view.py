...
class ViewProgramTest(TestCase):
    ...
    def test_authenticated_user_can_access_program(self):
        ...
        self.assertContains(response, "Test Program")  # Check if program title is shown
        self.assertContains(response, "Module 1")  # Check if module 1 is listed
        self.assertContains(response, "Module 2")  # Check if module 2 is listed
    ...
    def test_authenticated_user_not_enrolled_sees_not_found_page(self):
        ...
        # Try accessing a program the user is not enrolled in
